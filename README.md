...
- For `NaN` failures include the XML file of the last state before the crash, stored in `nan_error_logs`.
...
- [Periodic box size / nonbonded cutoff errors](#periodic-box-size-/nonbonded-cutoff-errors)
- [SMIRNOFF force field parameter assignment errors](#smirnoff-force-field-parameter-assignment-errors)
- [NaN errors during simulation](#nan-errors-during-simulation)
